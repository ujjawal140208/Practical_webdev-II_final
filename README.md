# PRACTICAL EXAM WED-DEV-II
## NOTE:
1. this repo has a src file which contains the components that has the existing question-1 and question-2.
2. Question-1 contains the like button codes
3. Question-2 contanis the fecthing data codes
